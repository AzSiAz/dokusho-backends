...
pub struct SourceSerie {
    ...
    pub title: Vec<MultiLanguageString>,
    pub alternates_titles: Vec<Vec<MultiLanguageString>>,
    pub cover: Url,
    pub synopsis: Vec<MultiLanguageString>,
...
impl Default for FetchSearchSerieFilter {
    fn default() -> Self {
        Self {
            query: None,
            order: None,
